  ...
  Future<dynamic> manejarErroresHttp(Object e) async{
    ...
    if (e is SocketException){
      ...
      return await RespuestaApiHelper.procesarRespuesta({
        "status": "errorCatch",
        "mensaje": "Sin conexión a internet. Verifica tu red e inténtalo nuevamente.",
      });
    }
    ...
    if (e is TimeoutException) {
      ...
      return await RespuestaApiHelper.procesarRespuesta({
        "status": "errorCatch",
        "mensaje": "La solicitud tardó demasiado. Inténtalo nuevamente en unos momentos.",
      });
    ...
    if (e is FormatException) {
      ...
      return await RespuestaApiHelper.procesarRespuesta({
        "status": "errorCatch",
        "mensaje": "Ocurrió un error inesperado al procesar la respuesta del servidor.",
      });
    }
    ...
    return await RespuestaApiHelper.procesarRespuesta({
      "status": "errorCatch",
      "mensaje": "No se pudo completar la solicitud. Inténtalo nuevamente más tarde.",
    });
  }
